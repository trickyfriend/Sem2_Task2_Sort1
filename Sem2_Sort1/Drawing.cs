...
namespace Sem2_Sort1
{
    public static class Drawing
    {
        ...
        private static void DrawArray(Graphics g, int[] arr, int x1, int y1, int x2, int y2, int dx, int fillSmaller, int fillBigger, int showSelected) 
            // переписать случаи под мою сортировку. Попробовать внести кисти в функции. И переписать условия, убрав повторяющиеся действия и использовав case вместо if/else.
        {
